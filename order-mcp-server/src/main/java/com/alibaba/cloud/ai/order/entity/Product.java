...
public class Product {
    ...
    @NotNull(message = "费用/占位金额不能为空")
    @DecimalMin(value = "0.00", message = "费用/占位金额不能为负数")
    private BigDecimal price;
    
    @Min(value = 0, message = "剩余名额不能为负数")
    private Integer stock;
    
    @Min(value = 1, message = "有效期或开放时长必须大于0")
    private Integer shelfTime;
    
    @Min(value = 1, message = "预计办理时间必须大于0")
