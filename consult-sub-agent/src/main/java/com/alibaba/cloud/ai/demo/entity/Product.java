...
package com.alibaba.cloud.ai.demo.entity;
...
/**
 * 校园服务事项实体类。
 * 底层沿用 products 表结构，业务语义为可办理或可预约的校园服务。
 */
public class Product {
    ...
    public Product(Long id, String name, String description, BigDecimal price, Integer stock, 
                   Integer shelfTime, Integer preparationTime, Boolean isSeasonal, 
                   LocalDateTime seasonStart, LocalDateTime seasonEnd, Boolean isRegional, 
                   String availableRegions, Boolean status) {
        this.id = id;
        this.name = name;
